...
WITH PR AS (
    SELECT AP.APNT_NO, PT.PT_NAME, PT.PT_NO, AP.MCDP_CD, AP.MDDR_ID, AP.APNT_YMD, AP.APNT_CNCL_YN
...
WHERE TO_CHAR(PR.APNT_YMD, 'YYYY-MM-DD') = '2022-04-13'
  AND PR.APNT_CNCL_YN = 'N'
