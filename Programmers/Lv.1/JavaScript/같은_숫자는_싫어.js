...
/*
    정확성  테스트
        ...
        테스트 17 〉	통과 (0.04ms, 33.7MB)

    효율성  테스트
        테스트 1 〉	통과 (12.30ms, 83MB)
        테스트 2 〉	통과 (12.01ms, 83.2MB)
        테스트 3 〉	통과 (13.66ms, 83.3MB)
        테스트 4 〉	통과 (12.16ms, 83.1MB)
...
function solution(arr)
{
    ...
    for (let i = 0, len = arr.length; i < len; i++) {
        ...
        if ((answerLen === 0) || (answer[answerLen - 1] !== arr[i])) {
            answer.push(arr[i]);
        }
    }
