/*
Lv. 3 #157341 - 대여 기록이 존재하는 자동차 리스트 구하기
...
FROM CAR_RENTAL_COMPANY_CAR CRC JOIN CAR_RENTAL_COMPANY_RENTAL_HISTORY CRH
    ON CRC.CAR_ID = CRH.CAR_ID
WHERE TO_CHAR(CRH.START_DATE, 'YYYY-MM') = '2022-10'
    AND CRC.CAR_TYPE = '세단'
