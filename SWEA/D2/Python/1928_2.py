...
PyCharm
직접 아무 문자나 입력하면 오류 발생
    Traceback (most recent call last):
      File "1928_2.py", line 81, in <module>
        result = b64decode(letters).decode('UTF-8') # base64 디코딩
...
#    result = base64.b64decode(letters).decode('UTF-8') # base64 디코딩
