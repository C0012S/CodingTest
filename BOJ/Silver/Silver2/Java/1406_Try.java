...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        int indexNum = N + 1; // 커서가 위치할 수 있는 곳의 경우의 수
        int nowIndex = indexNum; // 현재 커서가 위치한 곳 (1을 맨 앞으로 가정)

        Stack<String> stack = new Stack<>();
        for (int s = 0; s < N; s++) {
            stack.push(sentence.substring(s, s + 1));
        }
