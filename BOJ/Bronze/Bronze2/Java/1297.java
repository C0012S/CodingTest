...
1297. Bronze 2 - TV 크기
    ...
    2 초	    128 MB           12714	    7515      6900	         60.933%
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        int D = Integer.parseInt(token.nextToken()); // TV의 대각선 길이
        int H = Integer.parseInt(token.nextToken()); // TV의 높이 비율
        int W = Integer.parseInt(token.nextToken()); // TV의 너비 비율
