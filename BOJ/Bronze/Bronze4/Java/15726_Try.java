...
// 코드 길이 : 703B
// 계산 과정에서 소수점 아래를 버리면 두 연산의 경우의 비교가 제대로 이루어지지 않는다.
// 오답
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        int A = Integer.parseInt(token.nextToken()); // 정수 A (1 ≤ A ≤ 1,000,000)
        int B = Integer.parseInt(token.nextToken()); // 정수 B (1 ≤ B ≤ 1,000,000)
        int C = Integer.parseInt(token.nextToken()); // 정수 C (1 ≤ C ≤ 1,000,000)
